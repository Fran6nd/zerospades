...
namespace spades {
	namespace draw {
		...
		void VulkanOptimizedVoxelModel::CreatePipeline(VkRenderPass renderPass) {
			...
			std::vector<uint32_t> vertCode = LoadSPIRVFile("Shaders/BasicModelVertexColor.vert.spv");
			std::vector<uint32_t> fragCode = LoadSPIRVFile("Shaders/BasicModelVertexColor.frag.spv");
