...
#pragma mark - Scene Finalizer
		...
		void GLRenderer::DrawFilledTriangle(const Vector2& v0, const Vector2& v1, const Vector2& v2) {
			SPADES_MARK_FUNCTION();
			...
			imageRenderer->AddTriangle(v0.x, v0.y, v1.x, v1.y, v2.x, v2.y,
