...
namespace spades {
	namespace draw {
		...
		void VulkanDepthOfFieldFilter::CreatePipeline() {
			// Load programs
			cocGenProgram = renderer.RegisterProgram("Shaders/PostFilters/DoFCoCGen.vk.program");
			blurProgram = renderer.RegisterProgram("Shaders/PostFilters/DoFBlur.vk.program");
			gaussProgram = renderer.RegisterProgram("Shaders/PostFilters/Gauss1D.vk.program");
			finalMixProgram = renderer.RegisterProgram("Shaders/PostFilters/DoFMix.vk.program");
