...
namespace spades {
	...
	namespace gui {
		...
		public:
			...
			// Load / save .2kv6 scenes. A scene may legitimately hold no objects,
			// so loading reports failure separately from what it read.
			bool Load2KV6(const std::string& absPath, std::vector<VoxelObject>& out);
